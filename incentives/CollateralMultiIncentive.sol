...
contract CollateralMultiIncentive is MultiIncentiveBase, Initializable {
    /* ========== STATE VARIABLES ========== */
    ...
    function getUserAmount(
        ...
        return issuedPool.collateralAmount(account);
    }

    function getTotalAmount() public view override returns (uint256) {
        return issuedPool.totalCollateralAmount();
    }
